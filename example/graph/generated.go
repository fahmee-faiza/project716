...
type QueryResolver interface {
	...
	Admin(ctx context.Context) ([]*model.Character, error)
	User(ctx context.Context) ([]*model.Character, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Character.address":
		if e.complexity.Character.Address == nil {
			break
		}

		return e.complexity.Character.Address(childComplexity), true
...
func (ec *executionContext) _Character_address(ctx context.Context, field graphql.CollectedField, obj *model.Character) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Character_address(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Character_address(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Character",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_Mutation_upsertCharacter(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "address":
				return ec.fieldContext_Character_address(ctx, field)
			}
...
func (ec *executionContext) unmarshalInputCharacterInput(ctx context.Context, obj interface{}) (model.CharacterInput, error) {
	...
	fieldsInOrder := [...]string{"name", "id", "address"}
...
func (ec *executionContext) _Character(ctx context.Context, sel ast.SelectionSet, obj *model.Character) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "address":
			...
			out.Values[i] = ec._Character_address(ctx, field, obj)
