...
func (r *mutationResolver) UpsertCharacter(ctx context.Context, input model.CharacterInput) (*model.Character, error) {
	...
	character.Address = input.Address
...
func (r *queryResolver) Admin(ctx context.Context) ([]*model.Character, error) {
	panic(fmt.Errorf("not implemented: Admin - admin"))
}

// User is the resolver for the user field.
func (r *queryResolver) User(ctx context.Context) ([]*model.Character, error) {
